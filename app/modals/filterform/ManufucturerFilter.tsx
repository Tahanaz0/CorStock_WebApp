...
import buildingImage from "../../assets/images/building-05.png";

const ManufucturerFilter = () => {
  const manufacturerList = ["All", "HP", "Dell", "Lenovo"];
...
export default ManufucturerFilter;
